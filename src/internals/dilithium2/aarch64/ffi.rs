...
extern "C" {
    ...
    fn PQCLEAN_DILITHIUM2_AARCH64_polyveck_reduce(v: *mut PolyVecK);
    fn PQCLEAN_DILITHIUM2_AARCH64_polyvecl_reduce(v: *mut PolyVecL);
    ...
    fn PQCLEAN_DILITHIUM2_AARCH64_polyveck_caddq(t: *mut PolyVecK);
    ...
    fn PQCLEAN_DILITHIUM2_AARCH64_polyveck_add(
        w: *mut PolyVecK,
        u: *const PolyVecK,
        v: *const PolyVecK,
    );
    fn PQCLEAN_DILITHIUM2_AARCH64_polyvecl_add(
        w: *mut PolyVecL,
        u: *const PolyVecL,
        v: *const PolyVecL,
    );
    fn PQCLEAN_DILITHIUM2_AARCH64_polyveck_sub(
        w: *mut PolyVecK,
        u: *const PolyVecK,
        v: *const PolyVecK,
    );
...
pub fn polyveck_reduce(v: &mut PolyVecK) {
    unsafe { PQCLEAN_DILITHIUM2_AARCH64_polyveck_reduce(v as *mut _) };
}
pub fn polyvecl_reduce(v: &mut PolyVecL) {
    unsafe { PQCLEAN_DILITHIUM2_AARCH64_polyvecl_reduce(v as *mut _) };
}
...
pub fn polyveck_caddq(t: &mut PolyVecK) {
    unsafe { PQCLEAN_DILITHIUM2_AARCH64_polyveck_caddq(t as *mut _) };
}
...
pub fn polyveck_add_inplace(w: &mut PolyVecK, v: &PolyVecK) {
    unsafe { PQCLEAN_DILITHIUM2_AARCH64_polyveck_add(w as *mut _, w as *const _, v as *const _) };
}
/// Add the vector of polynomials `v` into the vector of polynomials `w`
/// in-place, modifying `w`.
pub fn polyvecl_add_inplace(w: &mut PolyVecL, v: &PolyVecL) {
    unsafe { PQCLEAN_DILITHIUM2_AARCH64_polyvecl_add(w as *mut _, w as *const _, v as *const _) };
}
...
pub fn polyveck_sub_inplace(w: &mut PolyVecK, v: &PolyVecK) {
    unsafe { PQCLEAN_DILITHIUM2_AARCH64_polyveck_sub(w as *mut _, w as *const _, v as *const _) };
}
