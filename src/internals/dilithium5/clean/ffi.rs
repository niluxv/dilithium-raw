...
extern "C" {
    ...
    fn PQCLEAN_DILITHIUM5_CLEAN_polyvecl_chknorm(v: *const PolyVecL, bound: i32) -> cty::c_int;
    fn PQCLEAN_DILITHIUM5_CLEAN_polyveck_chknorm(v: *const PolyVecK, bound: i32) -> cty::c_int;
