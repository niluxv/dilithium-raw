...
extern "C" {
    ...
    pub fn PQCLEAN_DILITHIUM3_AVX2_crypto_sign_keypair(
        pk: *mut [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_PUBLICKEYBYTES],
        sk: *mut [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_SECRETKEYBYTES],
        random: *mut [u8; 128],
    ) -> c_int;
    ...
    pub fn PQCLEAN_DILITHIUM3_AVX2_crypto_sign_signature(
        ...
        m: *const u8,
        mlen: size_t,
        sk: *const [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_SECRETKEYBYTES],
    ) -> c_int;
    ...
    pub fn PQCLEAN_DILITHIUM3_AVX2_crypto_sign_verify(
        ...
        m: *const u8,
        mlen: size_t,
        pk: *const [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_PUBLICKEYBYTES],
    ) -> c_int;
}
...
mod tests {
    ...
    fn test_sign_verify() {
        ...
        let mut seckey = [0u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_SECRETKEYBYTES];
        let mut pubkey = [0u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_PUBLICKEYBYTES];
        ...
        let res = unsafe {
            PQCLEAN_DILITHIUM3_AVX2_crypto_sign_keypair(
                &mut pubkey as *mut [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_PUBLICKEYBYTES],
                &mut seckey as *mut [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_SECRETKEYBYTES],
                &mut random as *mut [u8; 128],
            )
        };
        assert_eq!(res, 0);

        let mut sig = [9u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_BYTES];
        let mut len: usize = 0;
        let res = unsafe {
            PQCLEAN_DILITHIUM3_AVX2_crypto_sign_signature(
                ...
                msg as *const u8,
                msg.len(),
                &seckey as *const [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_SECRETKEYBYTES],
            )
        };
        assert_eq!(res, 0);
        ...
        let res = unsafe {
            PQCLEAN_DILITHIUM3_AVX2_crypto_sign_verify(
                ...
                msg as *const u8,
                msg.len(),
                &pubkey as *const [u8; PQCLEAN_DILITHIUM3_AVX2_CRYPTO_PUBLICKEYBYTES],
            )
        };
