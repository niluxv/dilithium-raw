...
pub mod clean {
    ...
    pub unsafe fn crypto_sign_keypair(
        ...
        unsafe {
            PQCLEAN_DILITHIUM5_CLEAN_crypto_sign_keypair(pk as *mut _, sk as *mut _, random as *mut _)
        }
    }
...
pub mod aarch64 {
    ...
    pub unsafe fn crypto_sign_keypair(
        ...
        unsafe {
            PQCLEAN_DILITHIUM5_AARCH64_crypto_sign_keypair(pk as *mut _, sk as *mut _, random as *mut _)
        }
    }
