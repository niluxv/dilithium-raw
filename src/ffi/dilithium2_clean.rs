...
extern "C" {
    ...
    pub fn PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_keypair(
        pk: *mut [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_PUBLICKEYBYTES],
        sk: *mut [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_SECRETKEYBYTES],
        random: *mut [u8; 128],
    ) -> c_int;
    ...
    pub fn PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_signature(
        ...
        m: *const u8,
        mlen: size_t,
        sk: *const [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_SECRETKEYBYTES],
    ) -> c_int;
    ...
    pub fn PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_verify(
        ...
        m: *const u8,
        mlen: size_t,
        pk: *const [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_PUBLICKEYBYTES],
    ) -> c_int;
}
    ...
    fn test_sign_verify() {
        ...
        let res = unsafe {
            PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_keypair(
                &mut pubkey as *mut [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_PUBLICKEYBYTES],
                &mut seckey as *mut [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_SECRETKEYBYTES],
        ...
        let res = unsafe {
            PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_signature(
                ...
                msg as *const u8,
                msg.len(),
                &seckey as *const [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_SECRETKEYBYTES],
            )
        };
        assert_eq!(res, 0);
        ...
        let res = unsafe {
            PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_verify(
                ...
                msg as *const u8,
                msg.len(),
                &pubkey as *const [u8; PQCLEAN_DILITHIUM2_CLEAN_CRYPTO_PUBLICKEYBYTES],
            )
        };
